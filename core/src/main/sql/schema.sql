...
CREATE TABLE IF NOT EXISTS "investor_stock" (
  "id" BIGSERIAL NOT NULL PRIMARY KEY,
  "investor_owner_id" BIGINT NOT NULL REFERENCES "investor" ("ID") ON DELETE CASCADE,
...
--CREATE TABLE IF NOT EXISTS "BUSINESS_MUTATE_JOURNAL" ("ID" BIGINT NOT NULL AUTO_INCREMENT, "BUS_ID" BIGINT NOT NULL, "MUTATOR_ID" BIGINT NOT NULL, "MUTATOR_ROLE" INTEGER NOT NULL, "INFO" VARCHAR NOT NULL);
...
-- CREATE TABLE IF NOT EXISTS "PROJECT" ("ID" BIGINT NOT NULL AUTO_INCREMENT, "NAME" VARCHAR NOT NULL, "DESC" VARCHAR NOT NULL, "DONE_PERCENT" DOUBLE PRECISION NOT NULL);
