...
create table "BUSINESS" ("ID" BIGINT NOT NULL AUTO_INCREMENT,"NAME" VARCHAR NOT NULL, "DESC" VARCHAR NOT NULL, "FUND" DOUBLE NOT NULL, "DIVIDE_SYS" DOUBLE NOT NULL, "DIVIDE_INVEST" DOUBLE NOT NULL);
...
create table "PROJECT_WATCHER" ("ID" BIGINT NOT NULL AUTO_INCREMENT, "INV_ID" BIGINT NOT NULL, "PROJ_ID" BIGINT NOT NULL);
