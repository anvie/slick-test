...
create table "BUSINESS_PROFIT" ("ID" BIGINT NOT NULL AUTO_INCREMENT, "BUS_ID" BIGINT NOT NULL, "OMZET" DOUBLE NOT NULL, "PROFIT" DOUBLE NOT NULL,
  "TS" TIMESTAMP NOT NULL, "MUTATOR_ID" BIGINT NOT NULL, "MUTATOR_ROLE" INTEGER NOT NULL, "INFO" VARCHAR NOT NULL);
