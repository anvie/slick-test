...
create table "ADMIN" ("ID" BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY,"NAME" VARCHAR NOT NULL, "PASSHASH" VARCHAR NOT NULL);
create table "OPERATOR" ("ID" BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY,"NAME" VARCHAR NOT NULL,"ABILITIES" VARCHAR NOT NULL, "PASSHASH" VARCHAR NOT NULL);
create table "INVESTOR" ("ID" BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY,"NAME" VARCHAR NOT NULL,
  "ROLE" INTEGER NOT NULL, "PASSHASH" VARCHAR NOT NULL,
  "STATUS" INTEGER NOT NULL DEFAULT 1);

-- BUSINESS ------------------

create table "BUSINESS" ("ID" BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE "PROFIT_SHARE_JOURNAL" ("BUS_ID" BIGINT NOT NULL,
  ...
  "SHARE_INITIATOR" VARCHAR(100) DEFAULT '',
